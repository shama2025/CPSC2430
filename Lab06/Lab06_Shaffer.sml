...
fun checkBetween0and9(a,b) = let fun isBetween0an9 n = n>= 0 andalso n <= 9 in isBetween0an9 a andalso isBetween0an9 b end;
...
fun myDiv(a,b) = if checkBetween0and9(a,b) then "The answer is" ^ mapToString(a div b) else "Error: Numbers not between 0 and 9";
